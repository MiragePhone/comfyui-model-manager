...
declare -a CONTROLNET_LIST=(
    "https://huggingface.co/lllyasviel/sd-controlnet-canny/resolve/main/diffusion_pytorch_model.safetensors|$CONTROLNET_DIR|control_canny.safetensors"
    "https://huggingface.co/lllyasviel/sd-controlnet-depth/resolve/main/diffusion_pytorch_model.safetensors|$CONTROLNET_DIR|control_depth.safetensors"
    "https://huggingface.co/comfyanonymous/ControlNet-v1-1_fp16_safetensors/resolve/main/control_v11p_sd15_canny_fp16.safetensors|$CONTROLNET_DIR|control_v11p_sd15_canny.safetensors"
)

declare -a EMBEDDINGS_LIST=(
    "https://civitai.com/api/download/models/42083|$EMBEDDINGS_DIR|"  # Easynegative
    "https://civitai.com/api/download/models/52471|$EMBEDDINGS_DIR|"  # Bad-hands-5
    "https://civitai.com/api/download/models/94022|$EMBEDDINGS_DIR|"  # UnrealisticDream
)

declare -a UPSCALERS_LIST=(
    "https://huggingface.co/uwg/4x_RealisticRescaler/resolve/main/4x-UltraRealistic-Rescaler-v3.pth|$UPSCALERS_DIR|4x_realistic_rescaler.pth"
    "https://huggingface.co/gemasai/4x_NMKD-Superscale-SP_178000_G/resolve/main/4x_NMKD-Superscale-SP_178000_G.pth|$UPSCALERS_DIR|4x_nmkd_superscale.pth"
    "https://huggingface.co/AUTOMATIC/stable-diffusion/resolve/main/extras/ESRGAN_1.pth|$UPSCALERS_DIR|ESRGAN_1.pth"
)
